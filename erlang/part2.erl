...
%%% Function: part2
%% ------------------------
%% part2 takes a matrix as input, sums together the fractions from division
%% between two integers where the rest is zero. It returns the sum.
part2(Input) ->
        ParentPid = self(),
        sum([receive
              {Pid,Result} ->
